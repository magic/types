...
const fn = {
  ...
  length: [
    { fn: () => is.length(3)('123'), info: 'is.length' },
    { fn: () => is.len(4)('1234'), info: 'is.len' },
    { fn: () => is.count(5)('12345'), info: 'is.count' },
    {
      fn: () => is.count(3)(new Set([1, 2, 3])),
      info: 'is.count works for sets',
    },
    {
      fn: () => is.count(5)(new Set([1, 2, 3])),
      expect: false,
      info: 'is.count falsifies set length',
    },
    {
      fn: () => is.count([1, 2, 3], new Set([1, 2, 3])),
      info: 'is.count array and Set',
    },
    {
      fn: () => is.count(new Map([['1', 1], ['2', 2]]), new Set([1, 2])),
      info: 'is.count Map and Set',
    },
    {
      fn: () => is.count([1, 2, 3], new Map([['1', 1], ['2', 2], ['3', 3]])),
      info: 'is.count array and Map',
    },
    {
      fn: () => is.count(new Map([['1', 1]]), new Map([['1', 1]])),
      info: 'is.count Map and Map',
    },
    {
      fn: () => is.count(new WeakMap([['1', 1]]), new WeakMap([['1', 1]])),
      info: 'is.count Map and Map',
    },
    { fn: () => is.count('123')('123'), info: 'compare strings' },
    { fn: () => is.len(0)({}), info: 'empty objects' },
    { fn: () => is.len(0)([]), info: 'empty arrays' },
    { fn: () => is.len(0)(''), info: 'empty strings' },
    { fn: () => is.len('')(''), info: 'empty strings' },
